...
export const insights: Insight[] = [
  {
    slug: 'an-ai-audit-should-produce-a-non-build-list',
    title: 'An AI Audit Should Produce a Non-Build List',
    category: 'Strategy',
    focus: 'Non-Build Decisions',
    date: '28 Aug 2026',
    author: 'Karan Chordia',
    publishedAt: '2026-08-28T11:35:02+05:30',
    readTime: '6 min read',
    summary: 'A practical audit artifact for deciding which AI ideas should be built, assisted, kept human-led, deferred, or rejected before tools enter the roadmap.',
    sourceLinks: [
      {
        label: 'Australian National AI Centre: Guidance for AI adoption - implementation guidance',
        url: 'https://www.ai.gov.au/staying-safe-and-responsible/essential-ai-practices/guidance-ai-adoption-implementation-guidance',
      },
      {
        label: 'UK Government Digital Service: Artificial Intelligence Playbook for the UK Government',
    ...
    content: [
      ...
      '<h3>Move From Possibility To Disposition</h3>',
      ...
      'That is why the earlier Kramaniti Insight on <a href="/insights/a-workflow-map-is-not-yet-a-build-decision"><gold>turning a workflow map into a build decision</gold></a> separates observation from commitment. The non-build list adds the other half of the decision: what was considered, why it did not enter the build queue, and what would need to change before it is reconsidered.',
      ...
      '<h3>Judge The Workflow Before The Capability</h3>',
      ...
      '[Fact] The Australian National AI Centre&apos;s current <a href="https://www.ai.gov.au/staying-safe-and-responsible/essential-ai-practices/guidance-ai-adoption-implementation-guidance" target="_blank" rel="noreferrer"><gold>Guidance for AI adoption</gold></a> tells organisations to document each system&apos;s intended use, foreseeable misuse, capabilities, limitations, and context. It also calls for explicit criteria for unacceptable risk and asks teams to consider the consequence of not deploying the system.',
      ...
      '<h3>Name The Reason Not To Build</h3>',
      ...
      '[Fact] The <a href="https://www.gov.uk/government/publications/ai-playbook-for-the-uk-government/artificial-intelligence-playbook-for-the-uk-government-html" target="_blank" rel="noreferrer"><gold>UK Government AI Playbook published on 10 February 2025</gold></a> recommends capturing and prioritising opportunities by feasibility and business value. Its business-case guidance also says stakeholders should first discuss whether AI needs to be used and, if so, which option offers the most useful improvement.',
      ...
      '<h3>Distinguish No From Not Yet</h3>',
      ...
      '<h3>Keep The Decision Beside The Roadmap</h3>',
      ...
      'This is one practical form of <a href="/insights/the-smallest-useful-ai-policy-is-a-workflow-note"><gold>keeping AI policy at the workflow level</gold></a>. The note tells the team what is permitted now, where the boundary sits, and what evidence is required before the route changes. It prevents a general enthusiasm for AI from overriding a specific business decision.',
      '<h3>Let Restraint Improve The Build Queue</h3>',
      ...
      '<h3>End The Audit With Two Lists</h3>',
      ...
      'This preserves Kramaniti&apos;s <a href="/#method"><gold>strategy before tools, systems before scale, and content after clarity</gold></a> sequence. Strategy removes weak commitments. Systems make the selected work maintainable. Communication reflects decisions the business can genuinely defend.',
  ...
  {
    slug: 'the-founders-judgment-is-a-content-standard',
    title: 'The Founder’s Judgment Is a Content Standard',
    category: 'Content',
    focus: 'Founder-Led Judgment',
    date: '26 Aug 2026',
    author: 'Karan Chordia',
    publishedAt: '2026-08-26T11:37:32+05:30',
    readTime: '6 min read',
    summary: 'A practical calibration playbook for turning founder judgment into an editorial standard that guides people and AI without making every draft wait for founder approval.',
    sourceLinks: [
      {
        label: 'Content Marketing Institute: How To Build Marketing Judgment Without Producing Clones',
        url: 'https://contentmarketinginstitute.com/career-development/build-marketing-judgment',
      },
      {
    ...
    content: [
      'Founder-led content should carry the founder&apos;s judgment. It should not require the founder to rewrite every sentence.',
      'That distinction matters as a business begins using editors, collaborators, templates, or AI-assisted drafting. The team can learn the preferred vocabulary and still miss the standard underneath it: which problem is worth discussing, what evidence is strong enough, which tradeoff should stay visible, and where a confident line would outrun the business.',
      '[Inference] The scalable part of a founder&apos;s voice is not imitation. It is a small decision system that helps another responsible person recognize what is useful, specific, supportable, and true to the way the business works.',
      '<h3>Separate Voice From Judgment</h3>',
      'Voice describes how the brand sounds: clear, grounded, practical, premium, and human. Judgment decides what the brand should say at all. It selects the operating lesson, the audience problem, the evidence, the boundary, and the useful next step.',
      'A voice guide can remove jargon and standardize tone. It cannot decide whether a support question is mature enough to become an article, whether an internal lesson can be made public, or whether a service statement needs softer language. Those are judgment calls.',
      '[Fact] A current <a href="https://contentmarketinginstitute.com/career-development/build-marketing-judgment" target="_blank" rel="noreferrer"><gold>Content Marketing Institute framework published on 11 August 2026</gold></a> warns that relying on AI tools and mentors can install taste instead of developing judgment. Its practical premise is that coaching should help people make original decisions rather than produce copies of the coach.',
      '[Inference] The same risk appears in founder-led communication. If the system teaches only preferred phrases, it creates a style imitation layer. If it teaches the reasons behind accepted and rejected messages, it begins to distribute editorial judgment.',
      '<h3>Build The Standard From Real Decisions</h3>',
      'A useful content standard should not begin with adjectives. Begin with three pieces of communication the founder approved and three they materially changed or rejected. For each one, record the reason.',
      '[Recommendation] Classify the reason under five fields: audience need, operating belief, source quality, claim boundary, and next action. The goal is to show what the decision protected. A rejected draft may have sounded polished but lacked a workflow source. An approved draft may have been simpler because it made the owner, sequence, and human boundary visible.',
      'This turns editorial feedback into reusable infrastructure. &quot;Make it sound more like me&quot; cannot guide the next draft. &quot;Name the business decision before describing the tool&quot; can.',
      'Kramaniti&apos;s Insight on <a href="/insights/founder-review-should-be-conditional-not-constant"><gold>making founder review conditional</gold></a> applies here. Routine, reversible content can move under a clear standard. Claims, pricing, proof, sensitive context, new positioning, and consequential promises should still return to the founder or named decision owner.',
      '<h3>Give Every Draft A Decision Trail</h3>',
      'The content brief should carry enough context for someone to make the first editorial decision without reconstructing the business in a meeting. It does not need to become a long strategy document.',
      '[Recommendation] Use seven fields: audience question, operating source, founder perspective, evidence available, claim boundary, format and channel, and review trigger. The operating source may be a repeated customer question, a workflow correction, a documented decision, a support pattern, or a lesson from building the system.',
      'The existing Kramaniti guide to <a href="/insights/the-content-calendar-needs-a-source-route"><gold>giving the content calendar a source route</gold></a> explains where ideas should come from. The founder judgment standard adds the decision layer: why this signal matters, what the business believes about it, and what can responsibly become public.',
      '[Inference] Together, the source route and judgment standard create the bridge from internal intelligence to external communication. One keeps the message attached to real work. The other keeps the interpretation attached to accountable human reasoning.',
      '<h3>Teach With Contrasts, Not Only Rules</h3>',
      'Rules become easier to apply when people can see the boundary. Pair a weak line with a stronger line and explain the decision between them.',
      'For example, &quot;we automate your business with AI&quot; is weak because it hides the workflow, the human boundary, and the operating condition. &quot;We audit the workflow, build the smallest useful system, and define where people remain responsible&quot; is stronger because it reflects a sequence the business can support.',
      '[Recommendation] Keep a small calibration set with four types of contrast: generic versus specific, possibility versus supported promise, tool-led versus workflow-led, and founder-dependent versus system-guided. Refresh the set when a new service, proof source, audience, or public boundary changes the standard.',
      '<h3>Use AI After The Editorial Boundary Is Clear</h3>',
      'AI can help turn one approved idea into channel variants, outline an article, surface repetition, simplify a passage, or check whether a draft is missing a source. It should not invent the founder&apos;s position or silently decide that an internal observation is safe to publish.',
      '[Fact] <a href="https://developers.google.com/search/docs/fundamentals/creating-helpful-content" target="_blank" rel="noreferrer"><gold>Google Search Central&apos;s people-first content guidance</gold></a>, updated on 10 December 2025, asks whether content offers original information or analysis, serves an intended audience, demonstrates first-hand expertise, has a clear primary purpose, and makes clear who created it, how it was produced, and why it exists.',
      '[Inference] Those questions are useful before search performance enters the discussion. A founder-led content system should be able to explain whose judgment shaped the message, which business experience or source informed it, how AI assisted, and why the audience needs it now.',
      '[Recommendation] Ask AI to work inside a completed brief. Let it propose options, but require every substantial claim, recommendation, and conclusion to remain traceable to the source packet or the named founder perspective. If the draft introduces a new position, stop and route it for judgment.',
      '<h3>Test Whether The Standard Can Travel</h3>',
      'Choose one real operating signal and ask another responsible person to prepare the brief and first draft. The founder should review the decisions before polishing the prose: source choice, audience relevance, claim strength, human boundary, and next step.',
      '[Recommendation] Record every correction as one of three things: a missing rule, a missing example, or a genuinely founder-only decision. Update the standard for the first two. Keep an explicit review trigger for the third. This prevents the content system from treating every correction as private taste.',
      'Karan&apos;s path from cinematic communication to workflow design and practical AI systems is part of the public <a href="/founder"><gold>founder context behind Kramaniti</gold></a>. The editorial standard should preserve that integrated point of view without turning biography into a substitute for evidence or requiring every public message to retell the same story.',
      '<h3>Let Founder-Led Clarity Become Shared Capability</h3>',
      'The aim is not to remove the founder from communication. It is to reserve founder attention for the decisions that shape meaning, trust, positioning, and promise.',
      'A usable standard lets routine content move with coherence, lets AI assist without flattening the point of view, and makes escalation visible when a message crosses into proof, risk, or strategic change. That is content after clarity in operating form.',
      '[Recommendation] Start with six real drafts, retain the decision behind each edit, and write the smallest standard another person can apply. The content system becomes coherent when founder judgment can guide the work without becoming the queue every draft must wait in.',
    ],
  },
  {
    slug: 'can-the-workflow-run-without-its-builder',
    title: 'Can the Workflow Run Without Its Builder?',
    category: 'Adoption',
    focus: 'Operational Independence',
    date: '24 Aug 2026',
    author: 'Karan Chordia',
    publishedAt: '2026-08-24T11:30:33+05:30',
    readTime: '6 min read',
    summary: 'A practical builder-exit test for checking whether an AI-assisted workflow has enough ownership, context, support, and recovery logic to operate without permanent creator dependence.',
    sourceLinks: [
      {
      ...
      {
        label: 'GOV.UK Service Standard: Operate a reliable service',
        url: 'https://www.gov.uk/service-manual/service-standard/point-14-operate-a-reliable-service',
      },
      {
        label: 'Google SRE Workbook: On-Call',
    ...
    content: [
      ...
      '<h3>Launch Is An Event. Adoption Is An Operating Condition.</h3>',
      ...
      '[Fact] The <a href="https://dora.dev/research/2025/dora-report/" target="_blank" rel="noreferrer"><gold>2025 DORA research</gold></a> describes AI as an amplifier of an organization&apos;s existing strengths and weaknesses, with the greatest returns coming from attention to the underlying organizational system rather than the tools alone.',
      ...
      '<h3>Run The Builder-Exit Test Before Expanding Usage</h3>',
      ...
      'This extends the previous Kramaniti pillar on <a href="/insights/documentation-is-the-operating-system-between-decisions"><gold>documentation between decisions</gold></a>. The builder-exit test checks whether that documentation is close enough to the work, specific enough to guide action, and small enough to remain current.',
      '<h3>Test Ownership, Not Familiarity</h3>',
      ...
      'The related Insight on <a href="/insights/show-the-support-route-before-rollout"><gold>showing the support route before rollout</gold></a> explains why support cannot remain an informal promise. People need to know where a question goes, what evidence should travel with it, who responds, and which repeated issue changes the standard.',
      '<h3>Make Failure Recoverable, Not Merely Visible</h3>',
      ...
      '[Fact] The <a href="https://www.gov.uk/service-manual/service-standard/point-14-operate-a-reliable-service" target="_blank" rel="noreferrer"><gold>GOV.UK standard for operating a reliable service</gold></a>, updated on 29 January 2026, calls for regular quality assurance overseen by the service team, testing in conditions similar to live use, appropriate monitoring, and a proportionate, sustainable response plan. It also says teams should monitor user outcomes and ethical issues, not only technical faults.',
      ...
      '<h3>Practice The Handoff With Real Cases</h3>',
      ...
      '<h3>Measure Dependence, Not Activity</h3>',
      ...
      '<h3>Let The Workflow Earn Its Next Stage</h3>',
      ...
      'Kramaniti&apos;s <a href="/#workflows"><gold>diagnose-to-iterate process</gold></a> makes this gate visible. Implementation creates the route. Enablement transfers the ability to use and support it. Iteration turns actual questions and failures into improvements. Skipping enablement leaves the build permanently attached to its builder.',
  ...
  {
    slug: 'documentation-is-the-operating-system-between-decisions',
    title: 'Documentation Is the Operating System Between Decisions',
    category: 'Systems',
    focus: 'Operational Documentation',
    date: '21 Aug 2026',
    author: 'Karan Chordia',
    publishedAt: '2026-08-21T16:19:06+05:30',
    readTime: '7 min read',
    summary: 'A pillar guide to the small decision records, question routes, review boundaries, and exception notes that turn scattered work into a system people can actually run.',
    sourceLinks: [
      {
    ...
    content: [
      ...
      '<h3>Carry The Reason, Not Only The Instruction</h3>',
      ...
      '<h3>Use The Right Artifact At The Right Moment</h3>',
      'The article on <a href="/insights/a-workflow-map-is-not-yet-a-build-decision"><gold>why a workflow map is not yet a build decision</gold></a> makes an important distinction. A map shows the route; a decision brief selects the constraint, boundary, human condition, and success signal. A team needs both, but not in the same format.',
      ...
      '<h3>Review Boundaries Keep Documentation Honest</h3>',
      ...
      'That is the practical contribution of <a href="/insights/founder-review-should-be-conditional-not-constant"><gold>conditional founder review</gold></a>. Known, reversible work can move under an agreed standard. Ambiguous, incomplete, external, or high-consequence work should arrive with the source packet and a named decision owner. The document does not try to automate the founder&apos;s judgment; it prevents routine work from consuming it.',
      ...
      '<h3>Exceptions Are The Maintenance Signal</h3>',
      ...
      '<h3>Let Internal Clarity Set The External Message</h3>',
      ...
      '<h3>Build A Small Documentation Spine</h3>',
      ...
      'That spine supports the same sequence that shapes Kramaniti&apos;s <a href="/#method"><gold>method</gold></a>. Strategy decides which decision matters. Systems give the decision a repeatable route. Content comes after the business can explain the route clearly and safely.',
  ...
  },
  {
    ...
    category: 'Systems',
    focus: 'Question Infrastructure',
    date: '17 Aug 2026',
    author: 'Karan Chordia',
    publishedAt: '2026-08-17T13:14:13+05:30',
    readTime: '6 min read',
    summary: 'A practical way to turn repeated questions, unclear requests, and scattered intake into scoped system work before choosing the tool.',
    sourceLinks: [
      {
        label: 'GOV.UK Service Manual: Form structure',
        url: 'https://www.gov.uk/service-manual/design/form-structure',
      },
      {
        label: 'GOV.UK Service Manual: Start by learning user needs',
    ...
    content: [
      ...
      '<h3>Separate The Question From The Requested Fix</h3>',
      ...
      'This protects Kramaniti&apos;s <a href="/#method"><gold>strategy before tools</gold></a> sequence in a very practical way. The business is not delaying implementation. It is locating the question that the implementation must reliably answer.',
      '<h3>Design Intake Around The Next Decision</h3>',
      ...
      '[Fact] GOV.UK&apos;s <a href="https://www.gov.uk/service-manual/design/form-structure" target="_blank" rel="noreferrer"><gold>form-structure guidance</gold></a> recommends keeping forms as short as possible, grouping related questions, placing easier questions before harder ones, and checking whether each question is needed to deliver the service. It also warns against asking for information before users understand why it is needed.',
      ...
      '<h3>Learn The Need Before Naming The Feature</h3>',
      ...
      '[Fact] GOV.UK&apos;s <a href="https://www.gov.uk/service-manual/user-research/start-by-learning-user-needs" target="_blank" rel="noreferrer"><gold>user-needs guidance</gold></a> says service teams should learn what users are trying to do, why they are trying to do it, and the outcome they need before designing a service around assumptions or organizational convenience.',
      ...
      'That is where this article extends the earlier Kramaniti piece on <a href="/insights/keep-the-note-beside-the-workflow"><gold>keeping operating notes beside the workflow</gold></a>. A note preserves an answer close to the work. Question capture decides which answers deserve to become operating memory in the first place.',
      '<h3>Make The Answer Easy To Use</h3>',
      ...
      '[Fact] W3C WAI&apos;s <a href="https://www.w3.org/WAI/tips/writing/" target="_blank" rel="noreferrer"><gold>writing-for-accessibility guidance</gold></a> recommends clear page titles, informative headings, meaningful link text, simple language, and instructions that do not rely only on sensory characteristics such as shape, size, or location.',
      ...
      '<h3>Turn Recurrence Into Scope</h3>',
      ...
      'This connects directly to Kramaniti&apos;s <a href="/#services"><gold>Systems Engineering</gold></a> work. The system is not scoped from tool appetite. It is scoped from the question route: what arrives, what evidence travels with it, who owns the answer, what can move without review, and what must change after the answer is used.',
      '<h3>Know When The Question Should Stay Human-Led</h3>',
      ...
      'The related article on <a href="/insights/the-human-checkpoint-checklist"><gold>human checkpoints</gold></a> is useful here: the issue is not whether humans are present somewhere in the workflow, but whether the right person sees the right evidence at the moment judgment changes the outcome.',
      ...
      '<h3>Build The Smallest Answering System</h3>',
  ...
  },
  {
    ...
    category: 'Strategy',
    focus: 'Audit Decisions',
    date: '07 Aug 2026',
    author: 'Karan Chordia',
    publishedAt: '2026-08-07T16:12:29+05:30',
    readTime: '6 min read',
    summary: 'A practical test for turning workflow observations into a scoped build decision with a named constraint, boundary, owner, and success signal.',
    sourceLinks: [
      {
        label: 'ASQ: Documentation and Process Mapping',
        url: 'https://asq.org/-/media/public/wqm/ASQ-WQM25_Document-ProcessMapping.pdf',
      },
      {
        label: 'Object Management Group: Business Process Model and Notation',
        url: 'https://www.omg.org/bpmn/',
      },
      {
        label: 'IEEE Task Force on Process Mining',
        url: 'https://www.tf-pm.org/',
      },
    ],
    content: [
      ...
      '[Inference] The useful output of a workflow audit is not documentation alone. It is a <gold>decision brief</gold> that converts observed work into an explicit investment choice.',
      '[infographic:map-to-decision-gate]',
      '<h3>Start With A Map That The Team Recognizes</h3>',
      ...
      '[Fact] ASQ&apos;s <a href="https://asq.org/-/media/public/wqm/ASQ-WQM25_Document-ProcessMapping.pdf" target="_blank" rel="noreferrer"><gold>2025 documentation and process-mapping guide</gold></a> recommends clarifying purpose and scope, gathering process performers and reviewers, recording suppliers, inputs, steps, outputs, customers, constraints, and measures, then validating the detailed map by walking through it with stakeholders. It also treats maintenance and version control as part of the practice rather than an afterthought.',
      ...
      'This extends the earlier Kramaniti guide to <a href="/insights/map-the-work-as-done-before-you-build"><gold>mapping work as done before building</gold></a>. The map earns trust by representing operating reality. The next task is to stop it from becoming a decorative endpoint.',
      '<h3>A Common Language Is A Bridge, Not A Verdict</h3>',
      '[Fact] The <a href="https://www.omg.org/bpmn/" target="_blank" rel="noreferrer"><gold>Object Management Group&apos;s BPMN standard</gold></a> is designed to make process notation understandable to business users while remaining precise enough for technical implementation. OMG describes it as a standardized bridge between process design and implementation.',
      ...
      'The related article on <a href="/insights/pick-the-constraint-before-you-pick-the-build"><gold>choosing the constraint before the build</gold></a> offers the prioritization principle. The audit decision brief makes that principle concrete by attaching the chosen constraint to scope, ownership, and verification.',
      '<h3>Use Digital Traces Without Mistaking Them For The Whole Workflow</h3>',
      ...
      '[Fact] The <a href="https://www.tf-pm.org/" target="_blank" rel="noreferrer"><gold>IEEE Task Force on Process Mining</gold></a>, whose public page was updated in June 2026, describes process mining as including automated process discovery from event logs, conformance checking between a model and recorded behavior, organizational mining, simulation, prediction, and history-based recommendations.',
      ...
      '<h3>Convert The Finding Into A Build Boundary</h3>',
      ...
      '<h3>Define The Success Signal Before The Tool</h3>',
      ...
      'This is where Kramaniti&apos;s <a href="/#workflows"><gold>diagnose, prioritize, architect, implement, enable, articulate, and iterate</gold></a> sequence becomes an audit contract. Diagnosis produces evidence. Prioritization names the constraint. Architecture defines the boundary. Implementation builds only the required support. Enablement assigns ownership. Iteration checks the signal and writes learning back into the route.',
      '<h3>End The Audit With A Decision The Business Can Defend</h3>',
  ...
  },
  {
    ...
    category: 'Adoption',
    focus: 'Founder Delegation',
    date: '05 Aug 2026',
    author: 'Karan Chordia',
    publishedAt: '2026-08-05T13:38:32+05:30',
    readTime: '6 min read',
    summary: 'A practical delegation protocol for moving routine AI-assisted work without turning founder judgment into a permanent approval queue.',
    sourceLinks: [
      {
        label: 'Microsoft Research: AI delegation and long-horizon reliability',
      ...
      {
        label: 'European Commission Joint Research Centre: The Impact of Human-AI Interaction on Discrimination',
        url: 'https://publications.jrc.ec.europa.eu/repository/handle/JRC139127',
      },
      {
        label: 'CHI 2025: AI, Help Me Think—but for Myself',
        url: 'https://www.microsoft.com/en-us/research/wp-content/uploads/2025/03/AI-Help-Me-Think-CHI-2025.pdf',
      },
    ],
    content: [
      ...
      '[Inference] The useful middle is <gold>conditional review</gold>: routine work moves under an agreed standard, while defined conditions trigger founder judgment. The founder owns the boundary, not every artifact that crosses it.',
      '[infographic:founder-review-boundary]',
      '<h3>Review The Condition, Not Every Artifact</h3>',
      ...
      '<h3>Human Presence Is Not The Same As Useful Oversight</h3>',
      ...
      '[Recommendation] Build the review brief beside the task. Include the intended outcome, source record, current standard, material change, known limitation, and reason the item has been escalated. This turns the <a href="/insights/the-human-checkpoint-checklist"><gold>human checkpoint</gold></a> from a generic approval into a specific act of judgment.',
      '<h3>Protect Founder Reasoning From Line-Edit Work</h3>',
      ...
      '[Fact] A 2025 CHI study compared recommendation-first AI with a reasoning-support approach in a small mixed-methods investment decision experiment. The <a href="https://www.microsoft.com/en-us/research/wp-content/uploads/2025/03/AI-Help-Me-Think-CHI-2025.pdf" target="_blank" rel="noreferrer"><gold>reasoning-support approach extended participants&apos; own rationales</gold></a> and helped them reflect on gaps in their thinking; the direct-recommendation approach offered more novel suggestions with less cognitive effort. The authors present the result as a design space with tradeoffs, not a universal verdict for all decisions.',
      ...
      'When the founder does review, capture the rationale rather than only the correction. &quot;Do not publish this line&quot; resolves one artifact. &quot;Do not imply a client outcome without permission-cleared evidence&quot; creates a reusable boundary. The latter can become a <a href="/insights/the-smallest-useful-ai-policy-is-a-workflow-note"><gold>workflow policy note</gold></a> that protects future work.',
      '<h3>Write A Founder Review Contract</h3>',
      ...
      'This is <a href="/founder"><gold>founder-led clarity</gold></a> expressed as operating design. The founder remains accountable for direction and consequential judgment while the team gains permission to move inside a clear, reviewable boundary.',
  ...
  {
    slug: 'the-exception-log-is-a-system-design-tool',
    title: 'The Exception Log Is a System Design Tool',
    category: 'Systems',
    focus: 'Exception Learning',
    date: '31 Jul 2026',
    author: 'Karan Chordia',
    publishedAt: '2026-07-31T15:45:31+05:30',
    readTime: '6 min read',
    summary: 'A practical guide to turning repeated overrides, support questions, and AI edge cases into better workflow rules without rebuilding the whole system.',
    sourceLinks: [
      {
        label: 'NIST: Challenges to the Monitoring of Deployed AI Systems',
        url: 'https://www.nist.gov/news-events/news/2026/03/new-report-challenges-monitoring-deployed-ai-systems',
      },
      {
        label: 'GOV.UK Service Manual: Monitoring the status of your service',
        url: 'https://www.gov.uk/service-manual/technology/monitoring-the-status-of-your-service',
      },
      {
        label: 'Google SRE: Postmortem Culture - Learning from Failure',
    ...
    content: [
      ...
      '[infographic:exception-learning-loop]',
      '<h3>Separate A True Exception From A Broken Standard</h3>',
      ...
      '<h3>Monitor The Work People Actually Experience</h3>',
      '[Fact] <a href="https://www.nist.gov/news-events/news/2026/03/new-report-challenges-monitoring-deployed-ai-systems"><gold>NIST&apos;s 2026 report on deployed AI monitoring</gold></a> separates monitoring into functionality, operations, human factors, security, compliance, and large-scale impacts. It also identifies fragmented logging, limited incident sharing, the burden of user feedback, and the challenge of balancing automated with human-validated monitoring.',
      ...
      '<h3>Recurring Errors Are Prioritization Signals</h3>',
      '[Fact] Updated <a href="https://www.gov.uk/service-manual/technology/monitoring-the-status-of-your-service"><gold>GOV.UK service-monitoring guidance</gold></a> recommends agreeing what to monitor, how to monitor it, and how to process and record issues. It notes that errors can reveal user problems, failing systems, security issues, or capacity problems, and that tracking them helps teams see what recurs.',
      ...
      '<h3>The Record Must End In An Owned Change</h3>',
      ...
      '[Fact] Google SRE&apos;s <a href="https://sre.google/workbook/postmortem-culture/"><gold>postmortem practice</gold></a> emphasizes factual records, clear ownership, concrete action items, and wide learning. It also warns that action items without ownership are less likely to be resolved.',
      ...
      '<h3>Keep The Learning Beside The Workflow</h3>',
      'The exception log should connect to the places where people already work. The related Insight on <a href="/insights/keep-the-note-beside-the-workflow"><gold>keeping operating notes beside the workflow</gold></a> explains why distance matters: a lesson stored in a polished archive will not help at the next moment of use.',
      'The same applies to adoption and review. The article on <a href="/insights/show-the-support-route-before-rollout"><gold>showing the support route before rollout</gold></a> makes questions visible, while the <a href="/insights/the-human-checkpoint-checklist"><gold>human checkpoint guide</gold></a> protects moments where trust, proof, money, privacy, taste, or final accountability changes the route. An exception log connects those two practices. It shows which questions are repeating and which checkpoints need a stronger rule.',
      ...
      '<h3>The Goal Is A Better Normal Route</h3>',
  ...
  {
    slug: 'alignment-turns-scattered-intelligence-into-systems',
    title: 'Alignment Turns Scattered Intelligence Into Systems',
    category: 'Strategy',
    focus: 'Alignment Route',
    date: '17 Jul 2026',
    author: 'Karan Chordia',
    publishedAt: '2026-07-17T14:34:25+05:30',
    readTime: '6 min read',
    summary: 'A cluster synthesis on turning repeated questions, workflow friction, support signals, operating notes, and human checkpoints into one practical alignment route before building the next system.',
    sourceLinks: [
      {
        label: 'IIBA BABOK: Requirements Life Cycle Management',
        url: 'https://www.iiba.org/knowledgehub/business-analysis-body-of-knowledge-babok-guide/5-requirements-life-cycle-management/',
      },
      {
      ...
      {
        label: 'OECD.AI: AI Principles overview',
        url: 'https://oecd.ai/en/ai-principles',
      },
      {
        label: 'ISO: ISO 9000 family - Quality management',
        url: 'https://www.iso.org/standards/popular/iso-9000-family',
      },
    ],
    content: [
      'Scattered intelligence does not become a system when a team buys another tool. It becomes a system when the business can name the route that keeps work, judgment, source material, support, and communication aligned.',
      'That is the practical promise behind an Alignment Audit. The audit is not a strategy deck on one side and an automation backlog on the other. It is a way to turn repeated friction into operating logic: what keeps happening, why it matters, who owns the decision, what evidence travels with the work, what should remain human-led, and what should be built only after that route is clear.',
      'The recent Kramaniti Insights archive has been circling the same operating problem from different sides: <a href="/insights/pick-the-constraint-before-you-pick-the-build"><gold>choosing the constraint before the build</gold></a>, making support visible before rollout, translating workflow into public presence, keeping operating notes beside the work, and placing human checkpoints where judgment changes the route. This post pulls those pieces into one stronger pillar: alignment is the route that turns scattered intelligence into systems.',
      '[Inference] The first system worth building is rarely the loudest request. It is the first route where better alignment changes how the business decides, hands off, supports, remembers, and communicates.',
      '[infographic:alignment-route-map]',
      '<h3>Start With The Route, Not The Asset</h3>',
      'Founders often see scattered intelligence as an asset problem. The answers are in too many notes. The team has too many calls. The content has too many drafts. The AI experiments live in too many private tabs. That diagnosis is partly true, but incomplete.',
      '[Inference] The deeper problem is route loss. A decision is made, but the requirement behind it is not traceable. A support question is answered, but the answer does not update the workflow. A founder edits a claim, but the proof boundary is not retained. A system output is reviewed, but the review does not improve the next cycle.',
      '[Fact] IIBA&apos;s <a href="https://www.iiba.org/knowledgehub/business-analysis-body-of-knowledge-babok-guide/5-requirements-life-cycle-management/"><gold>BABOK Requirements Life Cycle Management</gold></a> area names tasks such as trace requirements, maintain requirements, prioritize requirements, assess requirement changes, and approve requirements. The operating lesson is useful beyond formal business analysis: alignment depends on keeping the reason, change, priority, and approval path connected.',
      '[Recommendation] Before building anything, write the route in one line: this system supports [workflow], because [constraint], using [source packet], owned by [person], reviewed at [boundary], and improved when [signal repeats].',
      '<h3>The Constraint Gives The Route Its Shape</h3>',
      'The archive article on <a href="/insights/pick-the-constraint-before-you-pick-the-build"><gold>picking the constraint before the build</gold></a> argued that the first system should be chosen from where value actually stops moving. That idea becomes stronger inside an alignment route because the constraint is not only a bottleneck. It is the point that tells the business what kind of support is worth building.',
      'If the constraint is decision delay, the system may need a prioritization rule and decision record. If the constraint is customer confusion, the system may need a clearer intake route and public explanation. If the constraint is repeated AI correction, the system may need a source packet and review standard. If the constraint is founder reconstruction, the system may need a note placed beside the workflow.',
      '[Recommendation] Do not ask, &quot;what can AI do here?&quot; Ask which part of the route loses value when it depends on memory, improvisation, private judgment, or disconnected source material.',
      '<h3>Support Signals Are Alignment Data</h3>',
      'The article on <a href="/insights/show-the-support-route-before-rollout"><gold>showing the support route before rollout</gold></a> made the adoption point: a workflow is not ready because it exists; it is ready when people know where questions go, who answers them, what becomes reusable, and when the route should change.',
      '[Inference] Support signals are not after-sales noise. They are alignment data. Every repeated clarification, exception request, access problem, claim question, or AI correction shows where the operating route is unclear.',
      '[Recommendation] During the first live use of a system, keep a small support ledger: question, workflow moment, current answer, owner, escalation condition, and write-back target. The write-back target matters most. Without it, support stays conversational and the system does not learn.',
      '<h3>AI Amplifies The System Underneath It</h3>',
      '[Fact] <a href="https://dora.dev/research/"><gold>DORA&apos;s 2025 research summary</gold></a> says AI acts as an amplifier and points the greatest returns toward the underlying sociotechnical systems. That is a useful source-freshness signal for practical AI work: the model is not the operating layer by itself; it magnifies the quality of the workflow, feedback, documentation, and team practice underneath it.',
      '[Inference] This is why tool-first AI adoption often feels impressive in demos and fragile in daily work. If the workflow is unclear, AI accelerates unclear work. If the source packet is weak, AI repeats weak context. If the review route is invisible, AI increases review debt. If the public promise outruns the operating route, AI helps the brand sound confident before the business can support the claim.',
      '[Recommendation] Treat AI as a route multiplier. Before asking it to draft, decide, summarize, route, or support, define the workflow state it must receive and the write-back state it must leave behind.',
      '<h3>Operating Notes Preserve The Reason</h3>',
      'The article on <a href="/insights/keep-the-note-beside-the-workflow"><gold>keeping the note beside the workflow</gold></a> focused on one small habit: put the reason close to the work. That habit is what prevents alignment from becoming a one-time workshop.',
      'An operating note does not need to become a heavy knowledge base. It only needs to preserve enough route context for the next person or next cycle: what the decision is, why it exists, what source supports it, who owns it, what exception triggers review, and where it should be updated.',
      '[Recommendation] When the same explanation is reconstructed twice, convert it into a route note. The note should live where the next person already works, not in a polished archive that nobody opens during the moment of use.',
      '<h3>Human Checkpoints Protect Judgment Without Slowing Everything</h3>',
      'The archive article on <a href="/insights/the-human-checkpoint-checklist"><gold>human checkpoints</gold></a> argued for named review points where trust, public claims, commercial decisions, privacy, taste, or final responsibility changes the route. Inside an alignment system, those checkpoints are not blockers. They are the places where the route stays accountable.',
      '[Fact] The <a href="https://oecd.ai/en/ai-principles"><gold>OECD AI Principles</gold></a> include values such as human rights and democratic values, transparency and explainability, robustness, security and safety, and accountability. They were updated in May 2024, which makes them a current high-level reference for AI lifecycle responsibility.',
      '[Inference] A founder-led business does not need to turn every workflow into a compliance program. It does need to know which moments cannot be delegated to a tool without named human ownership.',
      '[Recommendation] Mark three classes in the route: automated where the answer is low-risk and repeatable, AI-assisted where the system can prepare or suggest, and human-led where trust, proof, taste, money, privacy, or final accountability changes the outcome.',
      '<h3>Presence Should Come From The Same Route</h3>',
      'The article on <a href="/insights/translate-the-workflow-then-write-the-page"><gold>translating the workflow before writing the page</gold></a> closes the loop. Public presence becomes coherent when the message reflects the route underneath it.',
      'A service page should know what intake question the business can answer. A founder post should know which operating lesson created the point of view. A case-study outline should know which proof is permission-cleared and which claim must stay soft. An Insights article should know which internal system, support signal, or decision route produced the lesson.',
      '[Inference] Content after clarity is not a delay tactic. It is a source discipline. The message gets sharper because the business has retained the operating reason behind it.',
      '<h3>The Alignment Route</h3>',
      '[Fact] ISO&apos;s <a href="https://www.iso.org/standards/popular/iso-9000-family"><gold>ISO 9000 family page</gold></a> frames quality management around improving products and services, consistently meeting customer expectations, process-oriented work, leadership involvement, and continuous improvement. That is the right operating analogy for a smaller practical AI system: quality is not inspected at the end; it is designed into the route.',
      '[Recommendation] Use six fields for the alignment route before the next build: constraint, requirement, owner, source packet, human boundary, and write-back signal. If any field is missing, the system may still be useful as a prototype, but it is not ready to become operating infrastructure.',
      'Alignment turns scattered intelligence into systems because it connects the business reality to the build route and the communication layer. The point is not to document everything. The point is to retain the parts of the work that change what should be built, who should decide, how people should adopt it, and what the brand can safely say in public.',
      'That is Kramaniti&apos;s sequence in operational form: strategy before tools, systems before scale, content after clarity. Start with the alignment route. Then build the smallest system that makes the route easier to run.',
    ],
  },
  {
  ...
  {
    slug: 'the-multi-agent-coordination-tax-why-orchestration-beats-automation',
    title: 'The Multi-Agent Coordination Tax: Why Orchestration Beats Automation',
    category: 'Systems',
    focus: 'Agentic Orchestration',
    date: '03 Jul 2026',
    author: 'Karan Chordia',
    publishedAt: '2026-07-03T11:45:00+05:30',
    readTime: '5 min read',
    summary: 'An architectural analysis of the communication and routing overhead in multi-agent systems—and why hierarchical orchestration is necessary to prevent token sprawl and execution loops.',
    sourceLinks: [
      {
        label: 'LangChain: LangGraph Orchestration & Workflows',
        url: 'https://www.langchain.com/',
      },
      {
        label: 'arXiv: Communication Overhead in Multi-Agent Systems',
        url: 'https://arxiv.org/',
      },
    ],
    content: [
      ...
      '<h3>The Fallacy of Unstructured Agent Collaboration</h3>',
      ...
      '[Inference] The solution is not to retreat to rigid, linear pipelines that break at the first sign of nuance. The solution is <gold>hierarchical orchestration</gold>—designing a central router or coordinator agent that owns task decomposition, agent selection, and quality gates.',
      ...
      '<h3>Deterministic Routing vs. Agentic Drift</h3>',
      ...
      '<h3>Orchestration Before Automation</h3>',
      ...
      '[Recommendation] Before deploying a complex multi-agent system, map the human team layout it represents. If your human team requires managers, review meetings, and clear role boundaries to function, your agent system will too. Treat multi-agent orchestration as a system design problem: <gold>strategy before tools, systems before scale, and clear orchestration before autonomous execution</gold>.'
    ]
  },
  {
