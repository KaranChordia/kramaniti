...
export const insights: Insight[] = [
  {
    ...
    content: [
      ...
      'This model used to work when the barrier to creating content was high. But today, generative AI has driven the cost of producing average text, images, and video down to zero. The result? A massive flood of generic, disconnected "AI slop" that dilutes brand identity and clogs up the internet.',
      ...
      'True scale requires treating operations and creative as a single, connected pipeline. It means laying a deep strategic foundation, engineering custom agentic workflows that understand that strategy, and then forcing the raw output of those systems through a rigorous, cinematic design filter.',
