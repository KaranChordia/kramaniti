...
app.get("/", (_req, res) => {
  res
    .type("text/plain")
    .send("Kramaniti Clarity Square Manager MCP server. Connect ChatGPT to /mcp.");
});
...
app.listen(port, () => {
  console.log(`Clarity Square Manager MCP server listening on http://localhost:${port}/mcp`);
});
